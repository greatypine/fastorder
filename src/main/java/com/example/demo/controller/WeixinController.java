...
import com.example.demo.utils.weixin.PayUtil;
import com.example.demo.utils.weixin.config.WxPayConfig;
import com.example.demo.utils.weixin.vo.OAuthJsToken;
...
public class WeixinController extends WeixinSupport{
    ...
    private static final String appid = "wx04ab7dabcda2692b";	    //微信小程序appid
    private static final String secret = "4b2e5bc35fe77f1c7711bab0383e60d0";	//微信小程序密钥
    ...
    public Map<String, Object> login(String code, HttpServletRequest request) throws WeixinException, IOException {
        ...
        if (jsonObj != null) {
            ...
            logger.info("openid=" + oauthJsToken.getOpenid()+"  session_key="+oauthJsToken.getSession_key());
    ...
    public Json wxPay(String openid, HttpServletRequest request){
        ...
        try{
            ...
            //商户订单号
            String orderNo = "wx_"+System.currentTimeMillis();
    ...
    public String doPhone(String session_key, String encryptedData,String iv) throws Exception {
        Json json = new Json();
        String decrypt = AESUtils.decrypt(encryptedData, session_key, iv, "UTF-8");
